...
class ConfigurationLoader:
    ...
    @staticmethod
    def load_search_config(config_path: str) -> Tuple[EmbeddingConfig, RerankerConfig, QdrantConfig, dict, str]:
        """
        ...
        Returns:
            Tuple of (EmbeddingConfig, RerankerConfig, QdrantConfig, search_params, log_level)
        """
        ...
        dense_config = DenseEmbeddingConfig(
            model_name=config_data.get('dense_model_name', 'BAAI/bge-base-en-v1.5'),
            device=config_data.get('device', 'cpu'),
            batch_size=config_data.get('embedding_batch_size', 32),
            use_fp16=config_data.get('use_fp16', False),
            show_progress_bar=config_data.get('show_progress_bar', False)
        )
        ...
        reranker_config = RerankerConfig(
            model_name=config_data.get('reranker_model_name', 'BAAI/bge-reranker-v2-m3'),
            device=config_data.get('device', 'cpu'),
            batch_size=config_data.get('reranker_batch_size', 32)
        )
        ...
        return embedding_config, reranker_config, qdrant_config, search_params, log_level
