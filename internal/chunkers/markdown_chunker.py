"""Markdown-specific document chunker - refactored from semantic_chunker.py"""
...
from ..parsers.markdown_parser import MarkdownParser, MarkdownElement, ElementType
...
from ..core.overlap_handler import OverlapHandler
from ..splitters.markdown.table_splitter import TableSplitter
from ..splitters.markdown.code_splitter import CodeSplitter
from ..splitters.markdown.list_splitter import ListSplitter
from ..splitters.markdown.text_splitter import TextSplitter
...
@dataclass
class Section:
    """Represents a semantic section of the markdown document"""
...
class MarkdownDocumentChunker(BaseDocumentChunker):
    ...
    def chunk_document(
        ...
        sections = self._analyze_sections(elements)
    ...
    def _analyze_sections(self, elements: List[MarkdownElement]) -> List[Section]:
        """
        Extract hierarchical sections from flat element list.
        Integrated SectionAnalyzer functionality.
